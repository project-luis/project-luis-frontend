    ...
    const getUserData = () => {
        ...
        axios
            ...
            .then((response) => {
                ...
                setUserProfile({
                    ...userData,
                    linkedInUrl: userData.linkedInUrl.startsWith("https://") || userData.linkedInUrl === ""
                    ? userData.linkedInUrl : "https://" + userData.linkedInUrl,
                    githubUrl: userData.githubUrl.startsWith("https://") || userData.githubUrl === ""
                    ? userData.githubUrl : "https://" + userData.githubUrl,
                });
